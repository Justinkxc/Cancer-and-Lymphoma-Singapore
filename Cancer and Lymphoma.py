...
plt.bar(range(len(data)), data.values(), align='center')
plt.xticks(range(len(data)), list(data.keys()))
plt.title("Top 5 Leading Cancers for females (2011-2015)")
plt.xlabel("Type of Cancer")
...
plt.bar(range(len(data)), data.values(), align='center')
plt.xticks(range(len(data)), list(data.keys()))
plt.title("Top 5 Leading Cancers for females in (2012-2016)")
plt.xlabel("Type of Cancer")
plt.ylabel("Age Standardised Incidence Rate (Per 100,000 per year)")
plt.show()
...
plt.bar(range(len(data)), data.values(), align='center')
plt.xticks(range(len(data)), list(data.keys()))
plt.title("Top 5 Leading Cancers for females in (2013-2017)")
plt.xlabel("Type of Cancer")
plt.ylabel("Age Standardised Incidence Rate (Per 100,000 per year)")
plt.show()
